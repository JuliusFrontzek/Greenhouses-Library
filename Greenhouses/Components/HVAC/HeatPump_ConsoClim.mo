...
model HeatPump_ConsoClim
  ...
  parameter Modelica.Units.SI.HeatFlowRate Q_dot_cd_n=10.02 "Nominal thermal power at the condenser";
  parameter Modelica.Units.SI.Temperature T_su_ev_n=7 "Nominal supply temperature at the evaporator";
  parameter Modelica.Units.SI.Temperature T_ex_cd_n=35 "Nominal exhaust temperature at the condenser";
  ...
  //Modelica.Units.SI.InstantaneousPower W_dot_pl;
  Real COP;
  Real DELTA_T;
  Real EIRFT;
  Real COP_fl;
