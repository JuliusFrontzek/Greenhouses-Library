...
model Solar_model "Global, PAR and NIR heat fluxes"
  ...
  /********************** Variables ***********************/
//   Modelica.Units.SI.HeatFlux R_SunCov_Glob;
//   Modelica.Units.SI.HeatFlux R_SunAir_Glob;
...
//   Modelica.Units.SI.HeatFlux R_SunCan_Glob "total short-wave radiation to the canopy";
...
//   Modelica.Units.SI.HeatFlux R_SunFlr_Glob "total short-wave radiation to the floor";
