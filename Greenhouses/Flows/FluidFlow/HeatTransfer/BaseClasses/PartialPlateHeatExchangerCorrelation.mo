...
partial model PartialPlateHeatExchangerCorrelation
  ...
  parameter Modelica.Units.SI.Length a_hat(min=0,displayUnit="mm",nominal=0.002) = 0.002
  ...
  annotation (Dialog(group="Geometry"));
  parameter Modelica.Units.SI.Length B_p(min=0,displayUnit="cm",nominal=0.10) = 0.1
    "Plate flow width"
  annotation (Dialog(group="Geometry"));
  ...
  annotation (Dialog(group="Advanced geometry"));
  replaceable parameter Modelica.Units.SI.Area A_cro = 2 * a_hat * B_p
