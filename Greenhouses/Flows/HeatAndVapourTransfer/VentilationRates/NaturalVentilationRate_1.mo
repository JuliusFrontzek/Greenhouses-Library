...
model NaturalVentilationRate_1
  ...
  /*********************** Varying inputs ***********************/
  Modelica.Units.SI.Velocity u= 0 "Wind speed"     annotation (Dialog(group="Varying inputs"));
  Modelica.Units.SI.Angle theta_l=0 "window opening at the leeside side" annotation (Dialog(group="Varying inputs"));
  Modelica.Units.SI.Angle theta_w=0 "window opening at the windward side" annotation (Dialog(group="Varying inputs"));
  Modelica.Units.SI.TemperatureDifference dT=10 annotation (Dialog(group="Varying inputs"));
