...
model Control_1 "Controller for the CHP and heat pump and TES"
  ...
  parameter Modelica.Units.SI.MassFlowRate Mdot_max=38 "Maximum mass flow rate in the greenhouse heating circuit";
  Modelica.Units.SI.Temperature T_high_tank = 90+273.15 annotation(Dialog(group="Varying inputs"));
